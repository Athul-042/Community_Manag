        ...
        return (
          <>
            ...
            <div className="profileCard">
              ...
              <button onClick={() => setPageView("viewpastvisitor")} style={{ padding: "10px 20px", backgroundColor: "#28a745", color: "white", border: "none", borderRadius: "4px", cursor: "pointer", marginBottom: "20px" }}>
                View Past Visitors
              </button>
              <button onClick={() => exportToExcel(visitors)} style={{ padding: "10px 20px", backgroundColor: "#007bff", color: "white", border: "none", borderRadius: "4px", cursor: "pointer", marginBottom: "20px", marginLeft: "10px" }}>
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                />
                <button onClick={() => setSearchDate("")} style={{ padding: "8px 15px", backgroundColor: "#6c757d", color: "white", border: "none", borderRadius: "4px", cursor: "pointer" }}>
                  Clear
                </button>
              </div>
              {visitors.length === 0 ? (
        ...
        return (
          <>
            ...
            <div className="profileCard">
              ...
              <button onClick={() => setPageView("viewdeliverylog")} style={{ padding: "10px 20px", backgroundColor: "#28a745", color: "white", border: "none", borderRadius: "4px", cursor: "pointer", marginBottom: "20px" }}>
                View Delivery Log
              </button>
