...
const styles = {
    ...
    // NEW: Container for side-by-side cards
    eventsGrid: {
        display: 'flex',
        flexWrap: 'wrap',
    ...
    // MODIFIED: Card style to match the layout (approx. 3 columns)
    eventCard: {
        background: '#fff',
        // Approximate width for 3 columns with gap
        width: 'calc(33.33% - 13.33px)', 
        minWidth: '280px', // Prevents shrinking too much
        padding: '0', 
        ...
        overflow: 'hidden', 
        // 🛑 ADDED: Margin at the bottom to visually separate cards
        marginBottom: '20px', 
    },
    contentArea: {
