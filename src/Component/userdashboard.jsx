    ...
    return (
      <>
        ...
        <div className="profileCard">
            ...
            {(userProfile.role === 'member' || !userProfile.role) && (
              <>
                ...
                <div className="detailItem">
                  ...
                  <span className="detailValue">{Array.isArray(userProfile.family_member) ? userProfile.family_member.map(m => m.name).join(', ') : 'N/A'}</span>
                </div>
                <div className="detailItem">
          ...
          {userProfile.role === 'member' && Array.isArray(userProfile.family_member) && userProfile.family_member.length > 0 && (
            <div style={{ marginTop: '20px' }}>
              <h4>Family Members</h4>
              <ul style={{ listStyleType: 'none', padding: 0 }}>
                {userProfile.family_member.map((member, index) => (
